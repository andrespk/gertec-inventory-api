...
public class ItemValidator : ValidatorBase<Item>
{
    public ItemValidator()
    {
        RuleFor(x => x.PartNumber)
            .NotEmpty()
            .Length(InventoryConstants.ItemPartNumberDefaultLength)
            .WithMessage(
        ...
        RuleFor(x => x.Name)
            .NotEmpty()
            .MaximumLength(InventoryConstants.ItemPartDescriptionDefaultMaxLength)
            .WithMessage(FormatMessage(BusinessMessages.InvalidItemDescriptionMaxLength,
                InventoryConstants.ItemPartNumberDefaultLength));

        RuleFor(x => x.Name)
            .NotEmpty()
            .MinimumLength(InventoryConstants.ItemPartDescriptionDefaultMinLength)
